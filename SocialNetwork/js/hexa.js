...
document.getElementById("deleteProfile").addEventListener("click", (e) => {
  ...
  let text = "Da li ste sigurni da želite izbrisati profil?";
...
document.getElementById("postForm").addEventListener("submit", (e) => {
  ...
  async function createPost() {
    ...
    document.getElementById("allPostsWrapper").innerHTML = `<div class = 'single-post' data-post-id='${post.id}'>
...
async function getAllPosts (){
    ...
    all_posts.forEach(post => {
        ...
        async function getPostUser(){
            ...
            document.getElementById("allPostsWrapper").innerHTML = `<div class = 'single-post' data-post_id='${post.id}'>
            <div class ='post-content'>${post.content}</div>
...
const commentPost = btn => {
  ...
  let main_post_el = btn.closest('.single-post');
  main_post_el.getAttribute('data-post_id');
